...
specular direction $\mathbf d_{\mathrm{ref}}$,
\begin{equation}
...
objective $\min_{\gamma,\omega}\max_k \overline{\Delta}_{k,\mathrm{IR}}$,
computed in closed form via \eqref{eq:matching} and the Gamma CDF.

\section{Numerical Results}
A $5{\times}5{\times}3$~m room is simulated with $M{=}1$, $N{=}4$, $K{=}3$
...
UE~1 entirely ($\E[\mathrm{ADR}_1]{=}0$, worst-case AoI $4.5$ rounds),
...
$\bar{\gamma}{=}3{\times}10^{15}$) attains per-user AoI
